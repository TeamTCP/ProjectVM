...
#include "AI/VMAIWarriorController.h"
...
AVMAIWarriorController::AVMAIWarriorController()
{
	static ConstructorHelpers::FObjectFinder<UBlackboardData> BBWAssetRef(TEXT("/Script/AIModule.BlackboardData'/Game/Project/AI/BB_VMWarrior.BB_VMWarrior'"));
	...
	static ConstructorHelpers::FObjectFinder<UBehaviorTree> BTWAssetRef(TEXT("/Script/AIModule.BehaviorTree'/Game/Project/AI/BT_VMWarrior.BT_VMWarrior'"));
...
void AVMAIWarriorController::OnPossess(APawn* InPawn)
{
...
void AVMAIWarriorController::OnUnPossess()
{
	UE_LOG(LogTemp, Log, TEXT("AVMAIWarriorController::OnUnPossess"));
}

void AVMAIWarriorController::RunAI()
{
	// 블랙보드 컴포넌트 포인터 가져오기.
...
void AVMAIWarriorController::StopAI()
{
